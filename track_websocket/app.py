...
class PedidoService:
    ...
    def get_status(self):
        # Conectar ao banco de dados e buscar o status do pedido por meio do id fornecido na url
        try:
...
class PedidoWebSocketHandler(tornado.websocket.WebSocketHandler):
    ...
    def enviar_atualizacao(self):
        ...
        self.write_message(
            json.dumps({"pedido_id": self.pedido_id, "status": status_atual})
        )
